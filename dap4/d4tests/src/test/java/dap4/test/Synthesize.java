...
public class Synthesize {
  ...
  public void synthesize(boolean checksumming, ByteOrder order, Commands commands) throws IOException {
  ...
  public void putcount(long count) throws IOException {
    bbtmp.position(0);
    bbtmp.putLong(count);
    writer.write(tmp, 0, bbtmp.position());
  }

  public void putvalue(DapType daptype, Object value) throws IOException {
  ...
  public void putchecksum(ByteBuffer b) throws IOException {
    if (!checksumming)
      return;
    int len = b.position();
    b.position(0);
