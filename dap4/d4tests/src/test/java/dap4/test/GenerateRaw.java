...
public class GenerateRaw extends DapTestCommon {
  ...
  static protected class TestCase {
    ...
    static public void setRoots(String resource) {
    ...
    public String makeurl() {
      String url = canonjoin(FAKEURLPREFIX, this.prefix, this.dataset) + this.suffix + ".dap";
      return url;
    }
  ...
  public void setup() throws Exception {
    StandaloneMockMvcBuilder mvcbuilder = USED4TS ? MockMvcBuilders.standaloneSetup(new D4TSController())
  ...
  protected void defineAlltestcases() {
    add(new TestCase("testfiles/test_atomic_array.nc"), new TestCase("testfiles/test_atomic_array.syn"),
        new TestCase("testfiles/test_atomic_types.nc"), new TestCase("testfiles/test_atomic_types.syn"),
        new TestCase("testfiles/test_enum.nc"), new TestCase("testfiles/test_enum_2.nc"),
        new TestCase("testfiles/test_enum_array.nc"), new TestCase("testfiles/test_fill.nc"),
        new TestCase("testfiles/test_groups1.nc"), new TestCase("testfiles/test_one_var.nc"),
        new TestCase("testfiles/test_one_vararray.nc"), new TestCase("testfiles/test_anon_dim.syn"),
        new TestCase("testfiles/test_unlim1.nc"), new TestCase("testfiles/test_utf8.nc"),
        new TestCase("testfiles/test_opaque.nc"), new TestCase("testfiles/test_opaque_array.nc"),
        new TestCase("testfiles/test_sequence_1.syn"), new TestCase("testfiles/test_sequence_2.syn"),
        new TestCase("testfiles/test_struct_array.nc"), new TestCase("testfiles/test_struct_array.syn"),
        new TestCase("testfiles/test_struct_nested.nc"), new TestCase("testfiles/test_struct_nested3.nc"),
        new TestCase("testfiles/test_struct_nested3.nc"), new TestCase("testfiles/test_struct1.nc"),
        new TestCase("testfiles/test_struct_type.nc"), new TestCase("testfiles/test_vlen1.nc"),
        new TestCase("testfiles/test_vlen2.nc"), new TestCase("testfiles/test_vlen3.nc"),
        new TestCase("testfiles/test_vlen4.nc"), // vlen inside a compound
        new TestCase("testfiles/test_vlen5.nc"), new TestCase("testfiles/test_vlen6.nc"),
        new TestCase("testfiles/test_vlen7.nc"), new TestCase("testfiles/test_vlen8.nc"),
  ...
  protected void add(TestCase... cases) {
