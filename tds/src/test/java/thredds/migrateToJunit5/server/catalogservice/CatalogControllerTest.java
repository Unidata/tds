package thredds.migrateToJunit5.server.catalogservice;
...
public class CatalogControllerTest {
  ...
  public static Collection<Object[]> getTestParameters() {
    return Arrays.asList(new Object[][] {
        ...
        {"/catalog/scanCdmUnitTests/agg/pointFeatureCollection/netCDFbuoydata/catalog.xml",
            ContentType.xml.getContentHeader()},});
  }
  ...
  public void validateCommandTest() throws Exception {
    ...
    MvcResult result = this.mockMvc.perform(rb).andExpect(MockMvcResultMatchers.status().is(400))
