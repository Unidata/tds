...
public class DatasetBoundariesTest {
  ...
  private String expectedWKT =
      "POLYGON((" + "130.000 0.000, 150.000 0.000, 170.000 0.000, 190.000 0.000, 210.000 0.000, " + // Bottom edge
  ...
  public void test(String testName, RequestBuilder requestBuilder, SupportedFormat expectedFormat,
      String expectedResponse) throws Exception {
    mockMvc.perform(requestBuilder).andExpect(status().isOk())
        .andExpect(content().contentType(expectedFormat.getMimeType())).andExpect(content().string(expectedResponse));
  }
}
