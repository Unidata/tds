...
public class TestCEEvaluator extends TdsUnitTestCommon {
  ...
  static final String[][] testsets = new String[][] {new String[] {"0", "temp_air_01082000.nc",
      // "1","?time",
      // "2","?longitude,latitude",
      // "3","?time[1:2]",
      "4", "?t[0:2:3][3:4][4:5][0:2:6]",}, new String[] {"0", "tst-PROFILER.nc", "1", "?wmoStaNum", "2", "staName"},};

  static final String[][] testsetsx =
      new String[][] {new String[] {"0", "temp_air_01082000.nc", "4", "?t[0:2:3][3:4][4:5][0:2:6]",}};
