...
public class TestEsgCats {
   ...
   * // count += crawler.crawl(
   * "file:B://esgf/ncar/esgcet/56/ucar.cgd.ccsm4.CESM_CAM5_BGC_LE_COMPROJ.ice.proc.monthly_ave.fswthru.v1.xml", null,
   * null, null);
   * 
   * /*
   * Path top = FileSystems.getDefault().getPath("B:/esgf/ncar/esgcet/1/");
  ...
  public static void main(String[] args) throws IOException, SecurityException {
    ...
    DatasetTracker.Callback callback =
        new ConfigCatalogInitialization.StatCallback(ConfigCatalogInitialization.ReadMode.always);
    ...
    // public ConfigCatalogInitialization(ReadMode readMode, String contentRootPath, String trackerDir, DatasetTracker
    // datasetTracker, CatalogWatcher catalogWatcher,
    // AllowedServices allowedServices, DatasetTracker.Callback callback, long maxDatasets) throws IOException {

    ConfigCatalogInitialization reader = new ConfigCatalogInitialization(ConfigCatalogInitialization.ReadMode.check,
        contentDir, null, tracker, allowedServices, callback, maxDatasets);
