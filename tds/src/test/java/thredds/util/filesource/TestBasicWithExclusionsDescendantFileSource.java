...
public class TestBasicWithExclusionsDescendantFileSource {
  ...
  public void testNewGivenNondirectoryFile() {
    ...
    assertTrue("The temporary non-directory file does not exist.", notDirFile.exists());
    assertFalse("The temporary non-directory file is a directory.", notDirFile.isDirectory());
    try {
  ...
  public void testNormalizedPath() {
    ...
    assertEquals("Root directory path not clean.", StringUtils.cleanPath(bfl.getRootDirectoryPath()),
  ...
  public void testBasics() {
    ...
    // Test getFile()
    assertNull("Did not get null from getFile(null).", bfl.getFile(null));
    ...
    assertEquals(filePath1_1, bfl.getRelativePath(bfl.getFile(filePath1_1)));
    assertEquals(filePath1_1, bfl.getRelativePath(new File(tmpDir, filePath1_1).getPath()));
    assertEquals(filePath1_1, bfl.getRelativePath(new File(tmpDir, "dir1/./file1_1").getPath()));
