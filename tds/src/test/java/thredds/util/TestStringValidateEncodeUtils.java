...
public class TestStringValidateEncodeUtils {
  ...
  public void testValidPath() {
    ...
    assertTrue("Invalid path when no extra character inserted.", StringValidateEncodeUtils.validPath(begin + end));
    assertTrue("Invalid path when [Latin small letter eth] character inserted.",
        StringValidateEncodeUtils.validPath(begin + '\u00F0' + end));
    assertTrue("Invalid path when [space] character inserted.", StringValidateEncodeUtils.validPath(begin + ' ' + end));
    ...
    assertFalse("Valid path when [tab] character inserted.", StringValidateEncodeUtils.validPath(begin + '\t' + end));
  ...
  public void testValidFilePath() {
    ...
    // The following should be valid file path strings.
    assertTrue("Invalid path when no extra character inserted.", StringValidateEncodeUtils.validFilePath(begin + end));
    assertTrue("Invalid path when [Latin small letter eth] character inserted.",
  ...
  public void testValidUriString() {
    ...
    // The following should be valid file path strings.
    assertTrue("Invalid path when no extra character inserted.", StringValidateEncodeUtils.validUriString(begin + end));
    assertTrue("Invalid path when [Latin small letter eth] character inserted.",
  ...
  public void testValidIdString() {
    ...
    // The following should be valid file path strings.
    assertTrue("Invalid path when no extra character inserted.", StringValidateEncodeUtils.validIdString(begin + end));
    assertTrue("Invalid path when [Latin small letter eth] character inserted.",
