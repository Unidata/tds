...
public class StringValidateEncodeUtils {
   ...
   * <p>
   * <p>
   * A string will be considered a valid single-line string if it does not
   ...
   * <p>
   * <p>
   * Or, in other words, allow: Letters, Numbers, Marks, Punctuation,
   ...
   * <p>
   * <p>
   * <strong>NOTE:</strong> Check compliance with URI RFC (RFC 3986) - TODO.
   *
  ...
  private final static Pattern VALID_DECIMAL_DIGITS_PATTERN = Pattern.compile("[\\+\\-]?[0-9]+");
  ...
  private final static Pattern VALID_CHARACTERS_FOR_BOOLEAN_STRING_PATTERN = Pattern.compile("[trueTRUEfalsFALS]*");
  ...
  private final static Pattern VALID_CHARACTERS_FOR_ALPHANUMERIC_STRING_PATTERN = Pattern.compile("[a-zA-Z0-9]*");
   ...
   * @return true if the given String is an alphanumeric string.
   */
  public static boolean validAlphanumericStringConstrainedSet(String alphNumString, String[] constrainedSet,
      boolean ignoreCase) {
  ...
  private final static Pattern VALID_PERCENT_HEX_OCTETS_PATTERN = Pattern.compile("(?:%[0-9a-fA-F]{2})*");
