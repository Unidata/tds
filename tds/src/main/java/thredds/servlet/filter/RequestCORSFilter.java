...
public class RequestCORSFilter extends OncePerRequestFilter {
  ...
  protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
    ...
    if (corsConfig.isEnabled()) {
      ...
      response.addHeader("Access-Control-Allow-Origin", corsConfig.getAllowedOrigin());
      ...
      if (request.getHeader("Access-Control-Request-Method") != null && "OPTIONS".equals(request.getMethod())) {
        ...
        response.addHeader("Access-Control-Max-Age", Integer.toString(corsConfig.getMaxAge()));
      }
    }
