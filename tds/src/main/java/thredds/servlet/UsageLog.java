 ...
 * <p/>
 * <p>
 * If properly configured, each log entry within the context thread
...
public class UsageLog {
   ...
   * <p/>
   * <p>
   * Call this method at every exit point in each HttpServlet doXXX() method
   * (e.g., doGet(), doPut()) or Spring MVC Controller handle() method.
   *
   ...
   * <p/>
   * <p>
   * Call this method only for non-request servlet activities, e.g.,
