...
public class TestFileServer {
  ...
  public static List<Object[]> getTestParameters() {
    ...
    result.add(
        new Object[] {"fileServer/rdaTest/ds094.2_dt/files/flxf01.gdas.A_PCP.SFC.01Z.grb2.gbx9", ContentType.binary.toString()});
    ...
    result.add(new Object[] {"fileServer/scanCdmUnitTests/formats/netcdf3/files/ctest0.nc", ContentType.netcdf.toString()}); // make
                                                                                                                  // sure
                                                                                                                  // files
                                                                                                                  // doesnt
                                                                                                                  // get
