...
https://www.unidata.ucar.edu/packages/netcdf/conventions.html[Convention].
...
chapter
https://www.unidata.ucar.edu/packages/netcdf-java/v2.1/NetcdfJavaUserManual.htm#_Toc42914935[3.2]
...
https://www.unidata.ucar.edu/packages/netcdf-java/v2.1/javadoc/index.html[javadoc]).
