...
3.  a valid https://www.unidata.ucar.edu/software/udunits/[udunits] date string
...
a valid https://www.unidata.ucar.edu/software/udunits/[udunits] time
duration string.
...
https://www.unidata.ucar.edu/software/netcdf-java/[Java-NetCDF library]
