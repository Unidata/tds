...
_https://www.unidata.ucar.edu/software/netcdf/conventions.html[Convention]_
...
https://www.unidata.ucar.edu/projects/THREDDS/tech/reference/WCS.html[WCS]
or the
https://www.unidata.ucar.edu/projects/THREDDS/tech/interfaceSpec/NetcdfSubsetService.html[Netcdf
Subset Service].
