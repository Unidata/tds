...
* [Basic NcML tutorial](https://docs.unidata.ucar.edu/netcdf-java/5.3/userguide/basic_ncml_tutorial.html){:target="_blank"}

### 10:30 (30 minutes) NcML aggregation (Sean)
* [NcML Aggregation](https://docs.unidata.ucar.edu/netcdf-java/5.3/userguide/ncml_aggregation.html){:target="_blank"}
